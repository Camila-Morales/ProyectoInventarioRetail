...
function getName(node) {
  if (AST11__namespace.isTsOnlyExpression(node)) {
    ...
    return {
      ...
      VariableDeclarator(node) {
        ...
        const hasState = node.id.properties.some(
          (prop) => prop.type === types.AST_NODE_TYPES.Property && isKeyLiteral(prop, prop.key) && getName(prop.key) === "state"
        );
        if (!hasState) {
          return;
        }
...
var no_context_provider_default = createRule({
  ...
  create(context) {
    ...
    return {
      JSXElement(node) {
        const [name5, ...rest] = JSX8__namespace.getElementName(node).split(".").reverse();
        if (name5 !== "Provider") return;
  ...
  create(context) {
    ...
    return {
      AssignmentExpression(node) {
        ...
        if (!core.isComponentName(object.name)) {
          return;
        }
...
function isAssignmentToThisState(node) {
  const { left } = node;
  return left.type === types.AST_NODE_TYPES.MemberExpression && AST11__namespace.isThisExpression(left.object) && getName2(left.property) === "state";
}
...
var RULE_NAME29 = "no-missing-context-display-name";
var RULE_FEATURES29 = [
  "CHK"
];
...
var RULE_NAME30 = "no-missing-key";
var RULE_FEATURES30 = [
  "CHK"
];
...
var RULE_NAME31 = "no-nested-components";
var RULE_FEATURES31 = [
  "CHK"
];
...
var RULE_NAME33 = "no-redundant-should-component-update";
var RULE_FEATURES33 = [
  "CHK"
];
...
var RULE_NAME34 = "no-set-state-in-component-did-mount";
var RULE_FEATURES34 = [
  "CHK"
];
...
var RULE_NAME35 = "no-set-state-in-component-did-update";
var RULE_FEATURES35 = [
  "CHK"
];
...
var RULE_NAME36 = "no-set-state-in-component-will-update";
var RULE_FEATURES36 = [
  "CHK"
];
...
var RULE_NAME37 = "no-string-refs";
var RULE_FEATURES37 = [
  "CHK"
];
...
var RULE_NAME38 = "no-unsafe-component-will-mount";
var RULE_FEATURES38 = [
  "CHK"
];
...
var RULE_NAME39 = "no-unsafe-component-will-receive-props";
var RULE_FEATURES39 = [
  "CHK"
];
...
var RULE_NAME40 = "no-unsafe-component-will-update";
var RULE_FEATURES40 = [
  "CHK"
];
...
var RULE_NAME41 = "no-unstable-context-value";
var RULE_FEATURES41 = [
  "CHK"
];
var no_unstable_context_value_default = createRule({
  ...
  create(context) {
    ...
    return {
      ...listeners,
      JSXOpeningElement(node) {
        const fullName = JSX8__namespace.getElementName(node.parent);
...
var RULE_NAME42 = "no-unstable-default-props";
var RULE_FEATURES42 = [
  "CHK"
];
...
var RULE_NAME43 = "no-unused-class-component-members";
var RULE_FEATURES43 = [
  "CHK"
];
  ...
  create(context) {
    ...
    return {
      ...
      MemberExpression(node) {
        ...
        const propertyName = getName3(node.property);
        ...
        if (node.init != null && AST11__namespace.isThisExpression(node.init) && node.id.type === types.AST_NODE_TYPES.ObjectPattern) {
          for (const prop of node.id.properties) {
            if (prop.type === types.AST_NODE_TYPES.Property && isKeyLiteral2(prop, prop.key)) {
              const keyName = getName3(prop.key);
              if (keyName != null) {
...
var RULE_NAME44 = "no-unused-state";
var RULE_FEATURES44 = [
  "CHK"
];
...
function isAssignmentToThisState2(node) {
  const { left } = node;
  return left.type === types.AST_NODE_TYPES.MemberExpression && AST11__namespace.isThisExpression(left.object) && getName4(left.property) === "state";
}
var no_unused_state_default = createRule({
  ...
  create(context) {
    ...
    return {
      AssignmentExpression(node) {
        if (!isAssignmentToThisState2(node)) {
          return;
        }
        const currentClass = classEntries.at(-1);
        if (currentClass == null || !core.isClassComponent(currentClass)) {
      ...
      MemberExpression(node) {
        ...
        if (getName4(node.property) !== "state") {
          return;
        }
        const currentClass = classEntries.at(-1);
        if (currentClass == null || !core.isClassComponent(currentClass)) {
      ...
      VariableDeclarator(node) {
        ...
        const hasState = node.id.properties.some((prop) => {
          if (prop.type === types.AST_NODE_TYPES.Property && isKeyLiteral3(prop, prop.key)) {
            return getName4(prop.key) === "state";
          }
          return false;
        });
        if (!hasState) {
...
var RULE_NAME45 = "no-use-context";
var RULE_FEATURES45 = [
  "CHK",
  "MOD"
];
    ...
    return {
      ...
      "Program:exit"(node) {
        ...
        function isFunctionComponent(block) {
          ...
          return id != null && core.isComponentName(id.name) && components.some((component) => component.node === block);
        }
    ...
    return {
      ...
      "Program:exit"(node) {
        ...
        for (const [, component] of components) {
          ...
          if (typeUtils.isTypeReadonly(services.program, propsType) || isReadonlyType(propsType, services)) {
            continue;
          }
