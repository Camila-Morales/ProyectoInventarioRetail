...
function getElementNameOnJsxAndDom(context, node, polymorphicPropName, additionalComponents = []) {
  const name3 = JSX__namespace.getElementName(node);
...
var no_void_elements_with_children_default = createRule({
  ...
  create(context) {
    return {
      JSXElement(node) {
        const elementName = JSX__namespace.getElementName(node);
