...
declare function hasNoneOrValidComponentName(context: RuleContext, node: AST.TSESTreeFunction): boolean;
...
declare function isReactHookCallWithNameAlias(context: RuleContext, name: string, alias: string[]): (node: TSESTree.CallExpression) => boolean;
